...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        Header header = new Header("helloWorld", "1.0", MAIN_SCREEN_ID, false, "icon-helloworld.png");
        Manifest manifest = new Manifest(header);

        RemoteData remoteData = new RemoteData("http://eripark.duapp.com/HelloWorld/hello");
        ...
        tableConfig.setRowConfig(new TableRowConfig(TableCellType.caption), new TableRowConfig(
                TableCellType.remoteImage));
